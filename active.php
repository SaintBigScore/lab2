...
<header class="header">
    ...
    <main>
        <p>
        <a>TOURISM DESTINATIONS</a><br>
        <a href="http://www.storydestination.com" target="_blank"><img src="assets/images/story.jpg" alt="storydestination">
        </p>
        <p>
        <a>FITNESS NEWS</a><br>
        <a href="http://www.fitness.com" target="_blank"><img src="assets/images/fitness.jpg" alt="fitness">
        </p>
    </main>
    <footer>
        <div class="footer">
